...
const GenreTable = ({ movies }) => {
  ...
  const filteredMovies = movies.filter(
    (movie) =>
      ...
      movie.Genre_ID.toLowerCase().includes(search.toLowerCase())
  );
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Genre Database</h1>
      ...
      <table className="min-w-full border-collapse border border-gray-300">
        ...
        <tbody>
          {currentMovies.map((movie) => (
            <tr key={movie.Genre_ID} className="odd:bg-white even:bg-gray-100 text-black">
